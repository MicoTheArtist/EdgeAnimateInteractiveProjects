   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid12", tween: [ "style", "${_Path}", "display", 'block', { fromValue: 'none'}], position: 1046, duration: 0 },
            { id: "eid52", tween: [ "style", "${_Path}", "display", 'none', { fromValue: 'block'}], position: 2000, duration: 0, easing: "easeOutBounce" },
            ...
            { id: "eid20", tween: [ "style", "${_SlideTwoHead}", "font-size", '24px', { fromValue: '24px'}], position: 1094, duration: 0, easing: "easeOutCubic" },
            { id: "eid37", tween: [ "style", "${_Tent}", "display", 'block', { fromValue: 'none'}], position: 3000, duration: 0, easing: "easeOutCubic" },
            { id: "eid26", tween: [ "style", "${_SnowPine}", "left", '0%', { fromValue: '100%'}], position: 2000, duration: 1000, easing: "easeOutCubic" },
            { id: "eid47", tween: [ "style", "${_Tent}", "left", '0.73%', { fromValue: '-30.42%'}], position: 3000, duration: 500, easing: "easeOutBounce" },
            ...
            { id: "eid11", tween: [ "style", "${_Path}", "left", '0px', { fromValue: '960px'}], position: 1000, duration: 1000, easing: "easeOutCubic" }         ]
      }
   }
},
"Forward": {
